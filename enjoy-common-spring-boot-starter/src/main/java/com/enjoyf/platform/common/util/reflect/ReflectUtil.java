package com.enjoyf.platform.common.util.reflect;

import com.enjoyf.platform.common.util.NamedTemplate;
...
public final class ReflectUtil {
    ...
    private static Object[] p_fieldsToArray(Object obj, int superLevels) {
        ...
        try {
            ...
            logger.error("ReflectUtil: Problem reflecting fields", e);
        }
