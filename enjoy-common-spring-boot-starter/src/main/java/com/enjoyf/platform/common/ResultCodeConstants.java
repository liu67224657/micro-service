...
public class ResultCodeConstants {
    ...
    public static final ResultCodeConstants COMMENT_BEAN_NULL = new ResultCodeConstants(-40008, "comment.bean.null", "ID不存在");
    ...
    public static final ResultCodeConstants COMMENT_HAS_AGREE = new ResultCodeConstants(-40016, "comment.has.agree", "已经点过赞了");
    ...
    public static final ResultCodeConstants COMMENT_PROFILE_FORBID = new ResultCodeConstants(-40019, "comment.profile.forbid", "用户已被封禁");
    ...
    public static final ResultCodeConstants COMMENT_HAS_EXIST = new ResultCodeConstants(-40023, "comment.has.exist", "已经点评过了");//
    ...
    public static final ResultCodeConstants SCORE_IS_NOT_NULL = new ResultCodeConstants(0, "score_is_not_null", "请选择评分");
    ...
    public JSONObject getJsonObject() {
        ...
        jsonObject.put("extmsg", StringUtils.isEmpty(this.getExtmsg()) ? this.getMsg() : this.getExtmsg());
        return jsonObject;
    }
    ...
    public String getJsonString(String callback) {
        ...
        return StringUtils.isEmpty(callback) ? jsonString : callback + "([" + jsonString + "])";
    }
