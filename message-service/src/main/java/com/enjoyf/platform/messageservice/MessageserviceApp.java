...
import com.enjoyf.platform.messageservice.config.DefaultProfileUtil;
...
public class MessageserviceApp {
    ...
    public MessageserviceApp(Environment env) {
        this.env = env;
    }
    ...
    public void initApplication() {
        ...
        log.info("\n----------------------------------------------------------\n\t" +
                "wikiappkey: \t{}\n\t" + " " +
                "\n----------------------------------------------------------",
            applicationProperties.getWikiappkey()
        );
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MessageserviceApp.class);
