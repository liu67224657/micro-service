...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        config.setInstanceName("user-service");
        ...
        config.getMapConfigs().put("com.enjoyf.platform.userservice.domain.*", initializeDomainMapConfig(jHipsterProperties));
